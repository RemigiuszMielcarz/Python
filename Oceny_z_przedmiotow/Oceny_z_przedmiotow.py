# ZADANIE: Napisz program, który umożliwi wprowadzanie ocen z podanego przedmiotu ścisłego (np. fizyki), 
...
def main(args):
    ...
    while True:
        ...
        if len(przedmiot): # Jeśli mamy już jakikolwiek przedmiot
    ...
    drukuj(oceny, przedmiot.capitalize() + " - wprowadzone oceny: ") # Metoda .capitalize() pozwala wydrukować podany napis dużą literą.
